...
WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign In/input_email'), '8639326702')

WebUI.click(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign In/input_password'), 'yApcPZgl258tA4QLdcldiw==')
